...
**Context:** If working in an isolated worktree, it should have been created via the `whalekit:using-git-worktrees` skill at execution time.

**Save plans to:** `docs/whalekit/plans/YYYY-MM-DD-<topic>-plan.md`
...
> **For agentic workers:** REQUIRED SUB-SKILL: Use whalekit:subagent-driven-development (recommended) or whalekit:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
**"Plan complete and saved to `docs/whalekit/plans/<filename>.md`. Two execution options:**
...
- **REQUIRED SUB-SKILL:** Use whalekit:executing-plans
